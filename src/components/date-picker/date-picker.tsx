...
import { Popover, PopoverContent, PopoverTrigger } from '../ui/popover'; import { usePathname, useSearchParams, useRouter } from 'next/navigation';
        ...
        <div className="flex items-center gap-2">
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                <PopoverTrigger asChild>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <CalendarIcon className="h-4 w-4 text-content-brand" />                            {date ? (
